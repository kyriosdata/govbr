/**
 * Código abaixo obtido de
 * https://manual-roteiro-integracao-login-unico.servicos.gov.br/pt/stable/exemplointegracao.html
 */
...
/**
 *
 * Aplicação que ilustra integração com
 * Autenticação GOV.BR.
 *
 */
public class Integracao {
     ...
     *
     * Após concluída essas três etapas, a aplicação
    ...
    private static String getFoto(String fotoUrl, String accessToken) throws Exception {
        ...
        try (InputStream inputStream = conn.getInputStream(); ByteArrayOutputStream baos = new ByteArrayOutputStream() ) {
            ...
            foto = "data:" + mimeType + ";base64," + Base64.getEncoder().encodeToString(baos.toByteArray());
        }
